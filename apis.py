...
#pygame.draw.rect(screen, color, [pos, [size, size]], 2)
...
while not done:
    ...
    for i in range(1,120):
        ...
        pygame.draw.arc(screen, BLACK,rect, 0,      pi/2,   2)
        pygame.draw.arc(screen, GREEN,rect, pi/2,   pi,     2)
        pygame.draw.arc(screen, BLUE, rect, pi,     3*pi/2, 2)
        pygame.draw.arc(screen, RED,  rect, 3*pi/2, 2*pi,   2)

    # Draw a circle
    # for i in range(1,40):
    #   pygame.draw.circle(screen, (int(i*250/40),int(i*250/40), 255), [60, 250], 41-i )

    drawPeg([ 60, 250], BLUE)
    drawPeg([150, 250], RED)
    drawPeg([240, 250], GREEN)
    drawPeg([330, 250], BLACK)
    drawPeg([420, 250], (170, 90, 170))
    drawPeg([510, 250], PURPLE)
    drawPeg([600, 250], ORANGE)

    #pygame.draw.circle(screen, (0, 0, 255), [60, 250], 40 )
    #pygame.draw.circle(screen, (255, 0, 0), [60, 250], 20 )
